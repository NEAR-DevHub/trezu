...
ALTER TABLE monitored_accounts
    ADD COLUMN IF NOT EXISTS confidential_access_token TEXT,
    ADD COLUMN IF NOT EXISTS confidential_refresh_token TEXT,
    ADD COLUMN IF NOT EXISTS confidential_token_expires_at TIMESTAMPTZ;
