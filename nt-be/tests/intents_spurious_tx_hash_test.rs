...
async fn test_intents_token_should_not_include_unrelated_tx_hashes(
    ...
    let intents_usdc_token = "intents.near:nep141:17208628f84f5d6ad33f0da3bbbeb27ffcb398eac501a31bd6ad2011e36133a1";
    ...
    println!("Balance:  {} -> {}", record.balance_before, record.balance_after);
    ...
    assert!(
        !record.transaction_hashes.contains(&unrelated_tx.to_string()),
