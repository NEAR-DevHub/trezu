...
function AnimateIcon({
    ...
    const [status, setStatus] = React.useState<"initial" | "animate">(
        "initial",
    );

    const delayRef = React.useRef<ReturnType<typeof setTimeout> | null>(null);
    const loopDelayRef = React.useRef<ReturnType<typeof setTimeout> | null>(
        null,
    );
...
>(animations: V): T {
    ...
    if (animationType in staticAnimations) {
        ...
        result =
            (animations[animationType as keyof V] as T) ?? animations.default;
    }
