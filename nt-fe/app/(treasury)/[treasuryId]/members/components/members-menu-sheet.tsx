...
const ITEM_CLASS =
    "h-14 w-full justify-start gap-3 rounded-[20px] bg-gray-100 px-5 text-base font-semibold text-foreground shadow-none hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/20";
